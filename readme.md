...
- [Bibliogram]([https://bibliogram.art](https://sr.ht/~cadence/bibliogram/)) - An alternative front-end for Instagram.
...
- [KaiMail](https://kaimail.net) - Privacy-focused email forwarding that does not scan message content. Envelope-level spam prevention only, with ARC/DKIM signing for forwarded messages. [Privacy policy](https://kaimail.net/en/legal/privacy-policy/).
